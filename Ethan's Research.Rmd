...
Delta2.Data3 <- Delta2.Data2 %>%
                  filter(sample.size >= 3) %>%
                    mutate(requisite.tval = qt(0.99, sample.size-1), observed.tval = abs((Mean.Delta2-overall.mean.Delta2))/standard.error) %>%
